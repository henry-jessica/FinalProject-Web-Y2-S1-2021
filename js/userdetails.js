...
if (localStorage.getItem('userdetails') === null) {  
    ...
    var userDetails = {firstName:"Walter", lastName:"Mitty", dob:"1990-12-01",zipcode:"R91 EVX3", address2:"Strandhill", address3:"Co. Sligo"};
    ...
    document.getElementById("zipcodeID").setAttribute('value', userDetails.zipcode);
...
function UpdateUserDetails() {
    ...
    userDetails.zipcode=document.getElementById('zipcodeID').value;   
